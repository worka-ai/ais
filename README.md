...
|------------|--------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|-------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|--------------|
| API Server | [api-x86_64-apple-darwin](https://github.com/worka-ai/ais/releases/latest/download/api-x86_64-apple-darwin)                                  | [api-aarch64-apple-darwin](https://github.com/worka-ai/ais/releases/latest/download/api-aarch64-apple-darwin)                                       | [api-x86_64-unknown-linux-gnu](https://github.com/worka-ai/ais/releases/latest/download/api-x86_64-unknown-linux-gnu)                                 | 🚧          | [api-x86_64-pc-windows-msvc.exe](https://github.com/worka-ai/ais/releases/latest/download/api-x86_64-pc-windows-msvc.exe)                             | [api-aarch64-pc-windows-msvc.exe](https://github.com/worka-ai/ais/releases/latest/download/api-aarch64-pc-windows-msvc.exe)                             | 🚧             | 🚧           |
| Worker     | [worker-x86_64-apple-darwin](https://github.com/worka-ai/ais/releases/latest/download/worker-x86_64-apple-darwin)                            | [worker-aarch64-apple-darwin](https://github.com/worka-ai/ais/releases/latest/download/worker-aarch64-apple-darwin)                                 | [worker-x86_64-unknown-linux-gnu](https://github.com/worka-ai/ais/releases/latest/download/worker-x86_64-unknown-linux-gnu)                             | 🚧          | [worker-x86_64-pc-windows-msvc.exe](https://github.com/worka-ai/ais/releases/latest/download/worker-x86_64-pc-windows-msvc.exe)                       | [worker-aarch64-pc-windows-msvc.exe](https://github.com/worka-ai/ais/releases/latest/download/worker-aarch64-pc-windows-msvc.exe)                       | 🚧             | 🚧           |
