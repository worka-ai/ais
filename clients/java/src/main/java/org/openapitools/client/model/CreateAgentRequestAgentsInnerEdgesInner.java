 ...
 */
@JsonPropertyOrder({
  CreateAgentRequestAgentsInnerEdgesInner.JSON_PROPERTY_CONDITIONS,
  CreateAgentRequestAgentsInnerEdgesInner.JSON_PROPERTY_PRIORITY,
  CreateAgentRequestAgentsInnerEdgesInner.JSON_PROPERTY_SCRIPT_CONDITION,
  CreateAgentRequestAgentsInnerEdgesInner.JSON_PROPERTY_TARGET_AGENT_ID
})
@JsonTypeName("CreateAgentRequest_agents_inner_edges_inner")
...
public class CreateAgentRequestAgentsInnerEdgesInner {
  ...
  public CreateAgentRequestAgentsInnerEdgesInner() {
  }

  public CreateAgentRequestAgentsInnerEdgesInner conditions(@javax.annotation.Nonnull List<Long> conditions) {
    
    this.conditions = conditions;
    return this;
  }

  public CreateAgentRequestAgentsInnerEdgesInner addConditionsItem(Long conditionsItem) {
  ...
  public CreateAgentRequestAgentsInnerEdgesInner priority(@javax.annotation.Nonnull Integer priority) {
  ...
  public CreateAgentRequestAgentsInnerEdgesInner scriptCondition(@javax.annotation.Nullable String scriptCondition) {
  ...
  public CreateAgentRequestAgentsInnerEdgesInner targetAgentId(@javax.annotation.Nonnull Long targetAgentId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAgentRequestAgentsInnerEdgesInner createAgentRequestAgentsInnerEdgesInner = (CreateAgentRequestAgentsInnerEdgesInner) o;
    return Objects.equals(this.conditions, createAgentRequestAgentsInnerEdgesInner.conditions) &&
        Objects.equals(this.priority, createAgentRequestAgentsInnerEdgesInner.priority) &&
        Objects.equals(this.scriptCondition, createAgentRequestAgentsInnerEdgesInner.scriptCondition) &&
        Objects.equals(this.targetAgentId, createAgentRequestAgentsInnerEdgesInner.targetAgentId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAgentRequestAgentsInnerEdgesInner {\n");
