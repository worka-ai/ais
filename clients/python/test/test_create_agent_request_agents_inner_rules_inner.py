...
class TestCreateAgentRequestAgentsInnerRulesInner(unittest.TestCase):
    """CreateAgentRequestAgentsInnerRulesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAgentRequestAgentsInnerRulesInner:
        """Test CreateAgentRequestAgentsInnerRulesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAgentRequestAgentsInnerRulesInner`
        """
        model = CreateAgentRequestAgentsInnerRulesInner()
        if include_optional:
            return CreateAgentRequestAgentsInnerRulesInner(
                content = '',
                description = '',
                id = 56,
                name = '',
    ...
    def testCreateAgentRequestAgentsInnerRulesInner(self):
        """Test CreateAgentRequestAgentsInnerRulesInner"""
