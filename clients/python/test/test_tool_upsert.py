...
class TestToolUpsert(unittest.TestCase):
    """ToolUpsert unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToolUpsert:
        """Test ToolUpsert
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToolUpsert`
        """
        model = ToolUpsert()
        if include_optional:
            return ToolUpsert(
