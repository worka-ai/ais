...
class CreateAgentRequestAgentsInnerRulesInnerToolsInner(BaseModel):
    """
    CreateAgentRequestAgentsInnerRulesInnerToolsInner
    """ # noqa: E501
    description: Optional[StrictStr] = None
    function_declarations: List[CreateAgentRequestAgentsInnerRulesInnerToolsInnerFunctionDeclarationsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "function_declarations": [CreateAgentRequestAgentsInnerRulesInnerToolsInnerFunctionDeclarationsInner.from_dict(_item) for _item in obj["function_declarations"]] if obj.get("function_declarations") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
