...
class UpsertAgentRequestAgentsInnerRulesInnerToolsInner(BaseModel):
    """
    UpsertAgentRequestAgentsInnerRulesInnerToolsInner
    """ # noqa: E501
    description: Optional[StrictStr] = None
    function_declarations: List[UpsertAgentRequestAgentsInnerRulesInnerToolsInnerFunctionDeclarationsInner]
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["description", "function_declarations", "id", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "function_declarations": [UpsertAgentRequestAgentsInnerRulesInnerToolsInnerFunctionDeclarationsInner.from_dict(_item) for _item in obj["function_declarations"]] if obj.get("function_declarations") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
