...
class CreateAgentRequestAgentsInner(BaseModel):
    """
    CreateAgentRequestAgentsInner
    """ # noqa: E501
    created_at: datetime
    description: StrictStr
    edges: List[CreateAgentRequestAgentsInnerEdgesInner]
    ...
    name: StrictStr
    rules: List[CreateAgentRequestAgentsInnerRulesInner]
    tags: Optional[List[StrictStr]] = None
    tenant_id: StrictInt
    tools: List[CreateAgentRequestAgentsInnerRulesInnerToolsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "edges": [CreateAgentRequestAgentsInnerEdgesInner.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None,
            "examples": obj.get("examples"),
            "expected_input": obj.get("expected_input"),
            "id": obj.get("id"),
            "is_default": obj.get("is_default"),
            "name": obj.get("name"),
            "rules": [CreateAgentRequestAgentsInnerRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
            "tags": obj.get("tags"),
