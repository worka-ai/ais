...
class CreateAgentRequest(BaseModel):
    ...
    CreateAgent
    """ # noqa: E501
    agents: List[CreateAgentRequestAgentsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agents": [CreateAgentRequestAgentsInner.from_dict(_item) for _item in obj["agents"]] if obj.get("agents") is not None else None
        })
        return _obj
