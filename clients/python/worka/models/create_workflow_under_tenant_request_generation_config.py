...
class CreateWorkflowUnderTenantRequestGenerationConfig(BaseModel):
    """
    CreateWorkflowUnderTenantRequestGenerationConfig
    """ # noqa: E501
    candidate_count: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["candidate_count", "max_output_tokens", "stop_sequences", "temperature", "top_k", "top_p"]
