...
/// UpsertLlmConfigRequest : UpsertLLMConfig (under a tenant)
...
impl UpsertLlmConfigRequest {
    /// UpsertLLMConfig (under a tenant)
    pub fn new(api_key: String, model: String, provider: String, temperature: f64) -> UpsertLlmConfigRequest {
