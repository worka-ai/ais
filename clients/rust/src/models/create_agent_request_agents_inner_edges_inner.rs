...
pub struct CreateAgentRequestAgentsInnerEdgesInner {
...
impl CreateAgentRequestAgentsInnerEdgesInner {
    pub fn new(conditions: Vec<i64>, priority: i32, target_agent_id: i64) -> CreateAgentRequestAgentsInnerEdgesInner {
